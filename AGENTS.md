...
This project is indexed by GitNexus as **goosie** (15825 symbols, 52058 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
