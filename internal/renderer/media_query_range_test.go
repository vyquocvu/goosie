...
func TestMediaQueryRangeSyntax(t *testing.T) {
	mq := NewMediaQueryEvaluator(1000, 800)
...
func TestMediaQueryRangeSyntaxIanaBehavior(t *testing.T) {
	desktop := NewMediaQueryEvaluator(1280, 800)
	compact := NewMediaQueryEvaluator(1000, 800)
...
func TestMediaQueryRangeAspectRatio(t *testing.T) {
	mq := NewMediaQueryEvaluator(1600, 900) // 16:9
