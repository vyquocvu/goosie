...
func TestRenderHTMLToImage_SimpleHTML(t *testing.T) {
	...
	img, err := RenderHTMLToImage(context.Background(), html, 800, 600)
	if err != nil {
...
func TestRenderHTMLToImage_EmptyHTML(t *testing.T) {
	img, err := RenderHTMLToImage(context.Background(), "", 800, 600)
	if err != nil {
		t.Fatalf("RenderHTMLToImage: %v", err)
	}
	if img == nil {
...
func TestRenderHTMLToImage_MinimalHTML(t *testing.T) {
	...
	img, err := RenderHTMLToImage(context.Background(), html, 400, 300)
	if err != nil {
		t.Fatalf("RenderHTMLToImage: %v", err)
	}
	if img == nil {
...
func TestRenderHTMLToImage_ZeroDimensions(t *testing.T) {
	...
	img, err := RenderHTMLToImage(context.Background(), html, 0, 0)
	if err != nil {
		t.Fatalf("RenderHTMLToImage: %v", err)
	}
	if img == nil {
...
func TestRenderHTMLToImage_NegativeDimensions(t *testing.T) {
	html := `<!DOCTYPE html><html><body><p>Hello</p></body></html>`
	img, err := RenderHTMLToImage(context.Background(), html, -100, -50)
	if err != nil {
		t.Fatalf("RenderHTMLToImage: %v", err)
	}
	if img == nil {
...
func TestRenderHTMLToImage_LargeDimensions(t *testing.T) {
	...
	img, err := RenderHTMLToImage(context.Background(), html, 1920, 1080)
	if err != nil {
		t.Fatalf("RenderHTMLToImage: %v", err)
	}
	if img == nil {
...
func TestRenderHTMLToImage_CancelledContext(t *testing.T) {
	...
	cancel()
	html := `<!DOCTYPE html><html><body><p>Hello</p></body></html>`
	_, err := RenderHTMLToImage(ctx, html, 800, 600)
	if err != nil {
...
func TestConvertPaintCommands_NilInput(t *testing.T) {
	result := convertPaintCommands(nil)
	if result == nil {
		t.Fatal("convertPaintCommands(nil) should return empty slice, not nil")
	}
	if len(result) != 0 {
...
func TestConvertPaintCommands_EmptyInput(t *testing.T) {
	result := convertPaintCommands([]*PaintCommand{})
	if result == nil {
		t.Fatal("convertPaintCommands(empty) should return empty slice, not nil")
	}
	if len(result) != 0 {
		t.Errorf("expected 0 commands, got %d", len(result))
	}
...
func TestConvertPaintCommands_SkipsNil(t *testing.T) {
	cmds := []*PaintCommand{
		nil,
		{Type: PaintRect, FillColor: image.Black, Box: Rect{X: 10, Y: 20, Width: 30, Height: 40}},
		nil,
	}
	result := convertPaintCommands(cmds)
	if len(result) != 1 {
...
func TestConvertPaintCommands_EmptyText(t *testing.T) {
	cmds := []*PaintCommand{
		{Type: PaintText, Text: "  ", Box: Rect{Width: 100, Height: 20}},
		{Type: PaintText, Text: "hello", Box: Rect{Width: 100, Height: 20}},
	}
	result := convertPaintCommands(cmds)
	if len(result) != 1 {
