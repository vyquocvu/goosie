...
<div class="gallery">
  ...
  <div class="gallery-item"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAIAAAACUFjqAAAAGElEQVR4nGJh+M+ABzDhkxy50oAAAAD//0PPARauNpI/AAAAAElFTkSuQmCC" alt="Green Image"><p class="label">Green Item</p></div>
</div>
</main>
