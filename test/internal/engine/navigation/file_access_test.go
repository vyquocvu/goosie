...
func TestCheckFileAccess_NonFileTarget(t *testing.T) {
	...
	for _, tt := range tests {
		err := navigation.CheckFileAccess(tt.current, tt.target)
		if err != nil {
...
func TestCheckFileAccess_FileTargetFromEmptyCurrent(t *testing.T) {
	...
	err := navigation.CheckFileAccess("", "file:///etc/passwd")
	if err != nil {
...
func TestCheckFileAccess_FileTargetFromFileOrigin(t *testing.T) {
	...
	err := navigation.CheckFileAccess("file:///home/user/page.html", "file:///home/user/other.html")
	if err != nil {
...
func TestCheckFileAccess_FileTargetFromHTTP(t *testing.T) {
	err := navigation.CheckFileAccess("https://example.com", "file:///etc/passwd")
	if err != navigation.ErrFileAccessDenied {
...
func TestCheckFileAccess_FileTargetFromHTTPWithPort(t *testing.T) {
	err := navigation.CheckFileAccess("http://localhost:8080/page", "file:///etc/shadow")
	if err != navigation.ErrFileAccessDenied {
...
func TestCheckFileAccess_FileTargetFromHTTPS(t *testing.T) {
	err := navigation.CheckFileAccess("https://evil.com", "file:///etc/passwd")
	if err != navigation.ErrFileAccessDenied {
		t.Fatalf("file:// from https origin should be denied, got: %v", err)
	}
}
...
func TestCheckFileAccess_FileTargetFromOpaqueOrigin(t *testing.T) {
	...
	err := navigation.CheckFileAccess("data:text/html,<script>malicious</script>", "file:///etc/passwd")
	if err != navigation.ErrFileAccessDenied {
		t.Fatalf("file:// from data: origin should be denied, got: %v", err)
	}

	err = navigation.CheckFileAccess("about:blank", "file:///etc/passwd")
	if err != navigation.ErrFileAccessDenied {
...
func TestCheckFileAccess_FileTargetFromBlob(t *testing.T) {
	err := navigation.CheckFileAccess("blob:https://example.com/uuid", "file:///etc/passwd")
	if err != navigation.ErrFileAccessDenied {
...
func TestCheckFileAccess_TargetParseError(t *testing.T) {
	...
	err := navigation.CheckFileAccess("https://example.com", "://invalid")
	if err != nil {
...
func TestCheckFileAccess_CurrentParseError(t *testing.T) {
	...
	err := navigation.CheckFileAccess("://invalid", "file:///etc/passwd")
	if err != nil {
...
func TestCheckFileAccess_FileTargetFromEmptyScheme(t *testing.T) {
	...
	err := navigation.CheckFileAccess("https://example.com", "/relative/path")
	if err != nil {
...
func TestCheckFileAccess_FileTargetFromIPAddress(t *testing.T) {
	err := navigation.CheckFileAccess("https://127.0.0.1", "file:///etc/passwd")
	if err != navigation.ErrFileAccessDenied {
...
func TestCheckFileAccess_FileTargetFromLocalhost(t *testing.T) {
	err := navigation.CheckFileAccess("http://localhost:3000", "file:///etc/passwd")
	if err != navigation.ErrFileAccessDenied {
...
func BenchmarkCheckFileAccess_Allowed(b *testing.B) {
	b.ReportAllocs()
	for range b.N {
		navigation.CheckFileAccess("https://example.com", "https://other.com")
	}
}
...
func BenchmarkCheckFileAccess_Denied(b *testing.B) {
	b.ReportAllocs()
	for range b.N {
		navigation.CheckFileAccess("https://example.com", "file:///etc/passwd")
	}
}
...
func BenchmarkCheckFileAccess_SameScheme(b *testing.B) {
	b.ReportAllocs()
	for range b.N {
		navigation.CheckFileAccess("file:///home/page.html", "file:///home/other.html")
	}
}
...
func BenchmarkCheckFileAccess_EmptyCurrent(b *testing.B) {
	b.ReportAllocs()
	for range b.N {
		navigation.CheckFileAccess("", "file:///etc/passwd")
	}
}
