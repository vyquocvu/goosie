...
func TestResolveURLRelative(t *testing.T) {
	...
	for _, tc := range cases {
		got, err := documentloader.ResolveURL(base, tc.ref)
		if err != nil {
...
func TestResolveURLAfterRedirect(t *testing.T) {
	...
	got, err := documentloader.ResolveURL(afterRedirect, "styles.css")
	if err != nil {
...
func TestResolveURLInvalidBase(t *testing.T) {
	_, err := documentloader.ResolveURL("://no-scheme", "x.css")
	if err == nil {
...
func TestResolveURLInvalidRef(t *testing.T) {
	_, err := documentloader.ResolveURL("https://example.com/", "://bad")
	if err == nil {
...
func TestIsHTTPOrHTTPS(t *testing.T) {
	...
	for in, want := range cases {
		got := documentloader.IsHTTPOrHTTPS(in)
		if got != want {
...
func TestResolveURLAgainstHTTPServer(t *testing.T) {
	...
	got, err := documentloader.ResolveURL(finalURL, "../css/theme.css")
	if err != nil {
