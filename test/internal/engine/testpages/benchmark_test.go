...
func BenchmarkGetContextDocumentation(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		page, err := testpages.GetContext(ctx, "documentation")
		if err != nil {
			b.Fatal(err)
		}
		if page.Name == "" {
...
func BenchmarkGetContextTableHeavy(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		page, err := testpages.GetContext(ctx, "table_heavy")
		if err != nil {
			b.Fatal(err)
		}
		if page.Name == "" {
...
func BenchmarkGetContextFormHeavy(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		page, err := testpages.GetContext(ctx, "form_heavy")
		if err != nil {
			b.Fatal(err)
		}
		if page.Name == "" {
...
func BenchmarkGetContextImageHeavy(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		page, err := testpages.GetContext(ctx, "image_heavy")
		if err != nil {
			b.Fatal(err)
		}
		if page.Name == "" {
...
func BenchmarkGetContextJavaScriptLightTodo(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		page, err := testpages.GetContext(ctx, "javascript_light_todo")
		if err != nil {
			b.Fatal(err)
		}
		if page.Name == "" {
...
func BenchmarkGetContextScrollingShort(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		page, err := testpages.GetContext(ctx, "scrolling_short")
		if err != nil {
			b.Fatal(err)
		}
		if page.Name == "" {
...
func BenchmarkGetContextScrollingLong(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		page, err := testpages.GetContext(ctx, "scrolling_long")
		if err != nil {
			b.Fatal(err)
		}
		if page.Name == "" {
