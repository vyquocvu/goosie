...
func TestDisplayListPanel_InitialState(t *testing.T) {
	...
	p := devtools.NewDisplayListPanelContent(func() *devtools.TabContext { return &devtools.TabContext{} })
	assert.NotNil(t, p)
}
...
func TestDisplayListPanel_NoRenderer(t *testing.T) {
	...
	p := devtools.NewDisplayListPanelContent(func() *devtools.TabContext { return ctx })
	assert.NotNil(t, p)
}
...
func TestDisplayList_TypeOrder(t *testing.T) {
	...
	assert.Equal(t, expected, devtools.DisplayListTypeOrder())
}
...
func TestDisplayList_FormatCommandLine(t *testing.T) {
	...
	for _, c := range cases {
		...
		t.Run(c.name, func(t *testing.T) {
			line := devtools.FormatCommandLine(0, c.cmd)
...
func TestDisplayList_FormatCommandDetail(t *testing.T) {
	...
	for _, c := range cases {
		c := c
		t.Run(c.name, func(t *testing.T) {
			detail := devtools.FormatCommandDetail(0, c.cmd)
...
func TestDisplayList_HighlightTarget(t *testing.T) {
	...
	var called int
	obj := devtools.NewDisplayListPanelWithHighlight(func() *devtools.TabContext { return ctx }, func(nodeID int) {
		called++
	})
	assert.NotNil(t, obj)
