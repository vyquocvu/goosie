...
func TestInheritedStyleEquality(t *testing.T) {
	a := css.DefaultInheritedStyle()
	b := css.DefaultInheritedStyle()
	if !a.Equal(&b) {
...
func TestComputedStyleInheritance(t *testing.T) {
	parent := css.DefaultComputedStyle()
	...
	child := css.DefaultComputedStyle()
...
func TestStylePoolBoundedEviction(t *testing.T) {
	pool := css.NewStylePoolWithLimit(4)
...
func TestApplyDeclarationsToInherited(t *testing.T) {
	decls := []css.Declaration{
		{Property: "color", Value: "red", PropertyAtom: css.InternPropertyName("color"), IsHot: true},
		{Property: "font-size", Value: "24px", PropertyAtom: css.InternPropertyName("font-size"), IsHot: true},
		{Property: "font-weight", Value: "bold", PropertyAtom: css.InternPropertyName("font-weight"), IsHot: true},
		{Property: "text-align", Value: "center", PropertyAtom: css.InternPropertyName("text-align"), IsHot: true},
	}

	s := css.DefaultInheritedStyle()
	css.ApplyDeclarationsToInherited(&s, decls)
...
func TestApplyDeclarationsToNonInherited(t *testing.T) {
	decls := []css.Declaration{
		{Property: "display", Value: "flex", PropertyAtom: css.InternPropertyName("display"), IsHot: true},
		{Property: "position", Value: "absolute", PropertyAtom: css.InternPropertyName("position"), IsHot: true},
		{Property: "margin-top", Value: "10px", PropertyAtom: css.InternPropertyName("margin-top"), IsHot: true},
		{Property: "z-index", Value: "5", PropertyAtom: css.InternPropertyName("z-index"), IsHot: true},
	}

	cs := css.DefaultComputedStyle()
	css.ApplyDeclarationsToNonInherited(&cs.NonInherited, decls)
...
func TestApplyDeclarationsEmptyValue(t *testing.T) {
	decls := []css.Declaration{
		{Property: "font-size", Value: "", PropertyAtom: css.InternPropertyName("font-size"), IsHot: true},
	}
...
func TestIsInheritedProperty(t *testing.T) {
	...
	for _, prop := range inherited {
		if !css.IsInheritedProperty(prop) {
...
func BenchmarkInheritedStyleEqual(b *testing.B) {
	a := css.DefaultInheritedStyle()
	bStyle := css.DefaultInheritedStyle()
	b.ResetTimer()
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		_ = a.Equal(&bStyle)
...
func BenchmarkApplyDeclarationsNonInherited(b *testing.B) {
	decls := []css.Declaration{
		{Property: "display", Value: "flex", PropertyAtom: css.InternPropertyName("display"), IsHot: true},
		{Property: "margin-top", Value: "10px", PropertyAtom: css.InternPropertyName("margin-top"), IsHot: true},
		{Property: "padding-left", Value: "5px", PropertyAtom: css.InternPropertyName("padding-left"), IsHot: true},
	}
	b.ResetTimer()
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
