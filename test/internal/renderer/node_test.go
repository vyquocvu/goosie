...
func TestBuildRenderTreeWithAttributes(t *testing.T) {
	...
	renderTree := renderer.BuildRenderTree(divNode)
	if renderTree == nil {
		t.Fatal("BuildRenderTree returned nil")
	}
...
func TestBuildRenderTreeTextNode(t *testing.T) {
	...
	renderTree := renderer.BuildRenderTree(pNode)
	if renderTree == nil {
		t.Fatal("BuildRenderTree returned nil")
	}
	...
	if textNode.Type != renderer.NodeTypeText {
...
func TestBuildRenderTreeWhitespace(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var texts []string
			var collectTexts func(*renderer.RenderNode)
			collectTexts = func(n *renderer.RenderNode) {
