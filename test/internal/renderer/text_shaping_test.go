...
func TestShapeTextBasicLatin(t *testing.T) {
	...
	result := shaper.Shape("Hello", renderer.FontKey{Size: 16})
	if result == nil {
...
func TestShapeTextEmpty(t *testing.T) {
	...
	result := shaper.Shape("", renderer.FontKey{Size: 16})
	if result == nil {
...
func TestTextShaper_Eviction(t *testing.T) {
	shaper := renderer.NewTextShaperWithCapacity(2)
	key := renderer.FontKey{Size: 16}
...
func TestShapeTextDifferentSizes(t *testing.T) {
	...
	result16 := shaper.Shape("Hello", renderer.FontKey{Size: 16})
	result32 := shaper.Shape("Hello", renderer.FontKey{Size: 32})
...
func TestShapeTextDifferentFonts(t *testing.T) {
	...
	resultNormal := shaper.Shape("Hello", renderer.FontKey{Size: 16, Bold: false, Italic: false})
	resultBold := shaper.Shape("Hello", renderer.FontKey{Size: 16, Bold: true, Italic: false})
...
func TestShapeTextDirection(t *testing.T) {
	...
	resultLTR := shaper.Shape("Hello", renderer.FontKey{Size: 16, Direction: renderer.DirectionLTR})
	resultRTL := shaper.Shape("Hello", renderer.FontKey{Size: 16, Direction: renderer.DirectionRTL})
...
func TestFontKeyValid(t *testing.T) {
	...
	invalid := renderer.FontKey{Size: 0}
	if invalid.Valid() {
		t.Error("FontKey with zero size should not be valid")
	}

	negative := renderer.FontKey{Size: -1}
	if negative.Valid() {
...
func TestFontKeyCacheKey(t *testing.T) {
	key1 := renderer.FontKey{Size: 16, Bold: false}
	key2 := renderer.FontKey{Size: 16, Bold: false}
	key3 := renderer.FontKey{Size: 16, Bold: true}
...
func TestShapedTextGlyphPositions(t *testing.T) {
	...
	result := shaper.Shape("ABC", renderer.FontKey{Size: 16})
	if result == nil {
		t.Fatal("Shape returned nil")
	}
...
func TestMeasureTextWrapped(t *testing.T) {
	...
	lines := shaper.MeasureWrapped(text, renderer.FontKey{Size: 16}, maxWidth)
	if len(lines) == 0 {
...
func TestMeasureTextWrappedEmpty(t *testing.T) {
	...
	lines := shaper.MeasureWrapped("", renderer.FontKey{Size: 16}, 100)
	if len(lines) != 0 {
...
func TestMeasureTextWrappedWhiteSpaceNoWrap(t *testing.T) {
	...
	lines := shaper.MeasureWrappedNoWrap(text, renderer.FontKey{Size: 16}, maxWidth)
	// Should not wrap
	if len(lines) != 1 {
...
func TestShapeTextMixedStyles(t *testing.T) {
	...
	result1 := shaper.Shape("Hello", renderer.FontKey{Size: 16, Bold: true})
	result2 := shaper.Shape(" World", renderer.FontKey{Size: 16, Italic: true})
...
func BenchmarkTextShaper_Eviction(b *testing.B) {
	shaper := renderer.NewTextShaperWithCapacity(128)
	key := renderer.FontKey{Size: 16}
...
func BenchmarkFontKeyCacheKey(b *testing.B) {
	key := renderer.FontKey{Size: 16, Bold: true, Italic: false}
