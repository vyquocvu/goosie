...
func TestMediaQueryEvaluator_BasicTypes(t *testing.T) {
	mq := renderer.NewMediaQueryEvaluator(800, 600)
...
func TestMediaQueryEvaluator_Orientation(t *testing.T) {
	landscapeMQ := renderer.NewMediaQueryEvaluator(800, 600)
	portraitMQ := renderer.NewMediaQueryEvaluator(600, 800)

	tests := []struct {
		name     string
		mq       *renderer.MediaQueryEvaluator
		prelude  string
		expected bool
	}{
