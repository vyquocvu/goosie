...
func createBenchmarkTree(n int) *renderer.RenderNode {
	if n <= 0 {
		return nil
	}
...
func createBenchmarkTreeRecursive(parent *renderer.RenderNode, remaining int, depth int) int {
