...
func splitCountRenderNodes(n *renderer.RenderNode) int {
	if n == nil {
		return 0
	}
	count := 1
...
func splitCollectText(n *renderer.RenderNode) []string {
	if n == nil {
		return nil
	}
	var out []string
	if n.Type == renderer.NodeTypeText && strings.TrimSpace(n.Text) != "" {
