...
func TestGetElementByID(t *testing.T) {
	...
	htmlContent := `<html><body><div id="test">Test Content</div><p id="para">Paragraph</p></body></html>`
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := parser.GetElementByID(htmlContent, tt.id)
			if (err != nil) != tt.wantErr {
...
func TestGetElementsByClassName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := parser.GetElementsByClassName(htmlContent, tt.className)
			if (err != nil) != tt.wantErr {
...
func TestGetElementsByTagName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := parser.GetElementsByTagName(htmlContent, tt.tagName)
			if (err != nil) != tt.wantErr {
...
func TestQuerySelector(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := parser.QuerySelector(htmlContent, tt.selector)
			if (err != nil) != tt.wantErr {
...
func TestQuerySelectorAll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := parser.QuerySelectorAll(htmlContent, tt.selector)
			if (err != nil) != tt.wantErr {
